...
public class CustomerRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtName.setToolTipText("Do not leave this empty.");
        ...
        txtPhoneNumber.setToolTipText("Follow this format: '0161118888'");
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if (error == 0) {
            Customer newCustomer = new Customer(name, emailAddress, phoneNumber, gender, password);
            Boolean dataRecordResults = newCustomer.recordData("Pending Users");
